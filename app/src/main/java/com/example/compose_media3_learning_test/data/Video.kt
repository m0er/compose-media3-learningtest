package com.example.compose_media3_learning_test.data
...
val verticalVideos = listOf(
    Video(
        ...
        subtitle = "By exit109",
        thumb = "",
        thumbLocal = R.raw.rw20seconds_1,
        title = "RW20seconds_1.mp4",
        width = 720,
        height = 1280
    ),
    Video(
        description = "",
        url = "rawresource:///${R.raw.vertical_video_sample1}",
        subtitle = "By Instagram reels",
        thumb = "rawresource:///${R.raw.vertical_video_thumb1}",
        thumbLocal = R.raw.vertical_video_thumb1,
        title = "vertical_video_sample1",
        width = 720,
        height = 1280
    ),
    Video(
        description = "",
        url = "https://www.exit109.com/~dnn/clips/RW20seconds_2.mp4",
        subtitle = "By exit109",
        thumb = "rawresource:///${R.raw.rw20seconds_2}",
        thumbLocal = R.raw.rw20seconds_2,
        title = "RW20seconds_1.mp4",
        width = 720,
        height = 1280
    ),
    Video(
        description = "",
        url = "rawresource:///${R.raw.vertical_video_sample2}",
        subtitle = "By Instagram reels",
        thumb = "rawresource:///${R.raw.vertical_video_thumb2}",
        thumbLocal = R.raw.vertical_video_thumb2,
        title = "vertical_video_sample2",
        width = 720,
        height = 1280
    ),
)
